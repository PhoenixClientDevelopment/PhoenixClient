...
public class SettingsWindow extends GuiWindow {
    ...
    protected void drawWindow(GuiGraphics graphics, Vector mousePos) {
        ...
        //Draw Title
        DrawUtil.drawText(graphics, getParentWindow().getTitle(), getPos().getAdded(new Vector(closeButton.getSize().getX() + 4 + 2,1 + getSize().getY()/2 - DrawUtil.getTextHeight()/2)), Color.WHITE);
