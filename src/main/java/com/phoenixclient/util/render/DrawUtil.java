...
public class DrawUtil {
    ...
    public static void drawText(GuiGraphics graphics, String text, Vector pos, Color color, boolean drawShadow, float scale) {
    ...
    public static void drawText(GuiGraphics graphics, String text, Vector pos, Color color) {
        drawText(graphics, text, pos, color, true, 1);
    }

    public static void drawDualColorText(GuiGraphics graphics, String text1, String text2, Vector pos, Color color1, Color color2) {
        drawText(graphics, text1, pos, color1);
        drawText(graphics, text2, pos.getAdded(new Vector(getTextWidth(text1) + 1, 0)), color2);
    }

    public static void drawDualColorText(GuiGraphics graphics, String text1, String text2, Vector pos, Color color1, Color color2, boolean drawShadow, float scale1, float scale2) {
        drawText(graphics, text1, pos, color1,drawShadow,scale1);
        drawText(graphics, text2, pos.getAdded(new Vector(getTextWidth(text1) + 1, 0)), color2,drawShadow,scale2);
    }
